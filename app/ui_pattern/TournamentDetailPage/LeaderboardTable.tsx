  ...
  return (
    <div className="space-y-4 user-drag-none select-none">
      ...
      <Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
        <DrawerContent className="bg-white max-h-[90vh] rounded-none!" showHandle={true}>
          ...
          {selectedPairPlayer ? (
            ...
            <div className="flex-1 overflow-auto p-4 space-y-8 user-drag-none select-none pb-40 min-h-[50vh] max-h-[70vh]">
            ...
            <div className="flex-1 overflow-auto p-4 space-y-4 pb-40 user-drag-none select-none min-h-[50vh] max-h-[70vh]">
