...
import { DotsThreeIcon, XIcon, UsersIcon } from "@phosphor-icons/react";
    ...
    <>
      <Drawer open={isOpen} onOpenChange={(open) => {
        ...
        <DrawerContent className="pb-2 max-h-[90vh] rounded-none!">
          ...
          <div className="flex flex-col gap-8 py-4 pb-20 overflow-y-auto flex-1 px-4 min-h-[50vh] max-h-[70vh]" onTouchStart={handleDrawerContentTouchStart}>
            {/* Input section */}
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between h-8">
                ...
                <div className="flex items-center gap-2">
                  <p className="text-sm font-medium text-clx-text-default">{players.length}</p>
